...
DIMENSION_WEIGHTS = {
    ...
    "ai": 1.3, "mobile": 1.0, "database": 1.1, "system_design": 1.2, "apis": 1.0,
    "linux": 1.1, "analytics": 1.0, "automation": 1.0, "ui_ux": 1.0,
    "networking": 1.1, "security": 1.3, "testing": 1.0, "machine_learning": 1.3
}

SKILL_VECTORS = {
    "sql": {"database": 1.0, "backend": 0.85, "data": 0.45, "analytics": 0.35, "devops": 0.08, "cloud": 0.08, "apis": 0.12},
    "python": {"backend": 1.05, "data": 0.75, "ai": 0.75, "automation": 0.45, "machine_learning": 0.35},
    "react": {"frontend": 1.0, "ui_ux": 0.75, "backend": 0.25, "mobile": 0.25},
    "flask": {"backend": 1.05, "apis": 0.95, "system_design": 0.6},
    "web apps": {"frontend": 0.6, "backend": 0.6},
    "node": {"backend": 0.9, "frontend": 0.3},
    "node.js": {"backend": 0.9, "frontend": 0.3},
    "docker": {"devops": 0.8, "cloud": 0.5, "automation": 0.75, "backend": 0.25, "networking": 0.15},
    "kubernetes": {"devops": 0.9, "cloud": 0.8, "automation": 0.8, "networking": 0.3},
    "terraform": {"devops": 0.8, "cloud": 0.8, "automation": 0.7, "security": 0.2},
    ...
    "git": {"devops": 0.6, "backend": 0.6, "testing": 0.2},
    "machine learning": {"ai": 1.0, "data": 0.6, "backend": 0.3, "machine_learning": 1.0},
    "data analysis": {"data": 1.0, "analytics": 0.6, "database": 0.6},
    "pandas": {"data": 0.9, "analytics": 0.6, "ai": 0.2},
    "powerbi": {"data": 0.8, "analytics": 0.7},
    "excel": {"data": 0.7, "analytics": 0.4},
    "api": {"backend": 0.8, "system_design": 0.5, "apis": 0.2},
    "apis": {"backend": 0.8, "system_design": 0.5, "apis": 0.4},
    ...
    "linux": {"devops": 0.9, "cloud": 0.6, "security": 0.35, "networking": 0.25, "backend": 0.25},
...
CAREER_VECTORS = {
    "Data Analyst": {"data": 1.0, "analytics": 0.9, "database": 0.5, "backend": 0.2, "ai": 0.3, "machine_learning": 0.2},
    "Backend Developer": {"backend": 1.0, "database": 0.8, "system_design": 0.8, "frontend": 0.3, "testing": 0.4, "security": 0.3, "apis": 0.5},
    "DevOps Engineer": {"devops": 1.0, "cloud": 0.9, "automation": 0.8, "backend": 0.4, "system_design": 0.6, "networking": 0.6, "security": 0.5},
    "Cloud Engineer": {"cloud": 1.0, "devops": 0.7, "automation": 0.6, "backend": 0.3, "system_design": 0.6, "networking": 0.8, "security": 0.6},
